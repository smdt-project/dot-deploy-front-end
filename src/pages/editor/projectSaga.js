...
function* workProjectUpdate(action) {
  ...
  action.payload._id
    ...
    const updatedLatests = latests.map((project) => project._id === updatedProject._id ? updatedProject : project)
    const updatedTopProjects = topProjects.map((project) => project._id === updatedProject._id ? updatedProject : project)
