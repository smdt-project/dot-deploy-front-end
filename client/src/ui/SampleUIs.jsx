...
const SampleUIs = () => {
	...
	return (
		<div
			ref={uiContainerRef}
			className="md:absolute md:right-0 md:top-0 flex flex-col items-end gap-8 md:pr-20 md:w-1/2 w-full opacity-80 md:translate-x-0 translate-x-20 md:scale-100 sm:scale-90 scale-75"
		>
